...
class ReactiveBleDesktopPlatform extends ReactiveBlePlatform {
          ...
          _characteristicValueController.add(CharacteristicValue(
              characteristic: QualifiedCharacteristic(
                  ...
                  serviceId: Uuid.parse(
                      ''), // The service ID is not provided by quick_blue
                  deviceId: deviceId),
  ...
  Future<List<DiscoveredService>> discoverServices(String deviceId) async {
    // QuickBlue.discoverServices(deviceId) and QuickBlue.setServiceHandler can be used to support it
    throw UnimplementedError('discoverServices is not implemented on Desktop');
  }
